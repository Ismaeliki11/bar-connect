...
export default function CocinaPage() {
  ...
  const [selectedShift, setSelectedShift] = useState<"mañana" | "tarde" | "cierre" | "todos">("mañana");
  ...
  const loadTasks = () => {
    if (currentUser) {
      ...
      const activeTasks = getTasksForDateAndShift("cocina", selectedDate, selectedShift);
  ...
  const handleToggleTask = (taskId: string, currentStatus: boolean) => {
    toggleTaskCompletion("cocina", taskId, selectedDate, !currentStatus);
    // Reload local list
    loadTasks();
  };
  ...
  const handleAddExtraTask = () => {
    ...
    addMasterTask({
      ...
      description: "Tarea extra añadida sobre la marcha.",
      category: "cocina",
      priority: null,
      shift: selectedShift === "todos" ? "mañana" : selectedShift,
      frequency: "unica",
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <p className="text-xs text-on-surface-variant mt-0.5">
                Organiza la preparación y limpieza de cocina
              </p>
            </motion.div>
                ...
                <div className="py-10 text-center bg-surface-white border border-outline-variant/50 rounded-xl p-4">
                  <p className="text-sm font-medium text-on-surface-variant/80">
                    {total === 0
                      ...
                      : "¡Buen trabajo! Has completado todas las tareas."}
                  </p>
                  <p className="text-xs text-on-surface-variant/60 mt-1">
                    {total === 0
                      ? "Gestiona la plantilla de tareas recurrentes arriba o añade una tarea extra abajo."
          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Ej: Fregar campanas, reponer platos..."
